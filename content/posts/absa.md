...
Here I report on [approaches to ABSA](#approaches) as a Bert Sentence Pair Classification (BERT-SPC) problem together with domain adaptation of the Bert language model (BERT-ADA). I also present my [implementation](#experiments) of both BERT-SPC and BERT-ADA.
